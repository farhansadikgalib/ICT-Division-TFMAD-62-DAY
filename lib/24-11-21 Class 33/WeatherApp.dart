...
class _WeatherAppWithAPIState extends State<WeatherAppWithAPI> {
  ...
  Future getWeather() async {
    final response = await http.get(Uri.parse(
        'https://api.openweathermap.org/data/2.5/weather?q=dhaka&units=metric&appid=5a57dcbf2289448493158ffba84bb1e0'));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(
          "Open Weather",
          style: TextStyle(color: Colors.black, fontFamily: "azonix"),
        ),
        centerTitle: true,
          ...
          Expanded(
            ...
            children: [
              ListTile(
                ...
                trailing:
                    Text(min != null ? min.toString() + "\u00B0 C" : '25'),
              ),
              ListTile(
                tileColor: Colors.cyan,
                ...
                trailing:
                    Text(max != null ? max.toString() + "\u00B0 C" : '25'),
              ),
              ListTile(
                tileColor: Colors.cyan,
              ...
              ListTile(
                ...
                title: Text("Humidity"),
                trailing:
                    Text(humidity != null ? humidity.toString() + "Pa" : '25'),
              ),
              ListTile(
                tileColor: Colors.cyan,
                ...
                trailing: Text(
                    windspeed != null ? windspeed.toString() + " km/h" : '25'),
              ),
              ListTile(
                tileColor: Colors.cyan,
